...
import citiesRouter from './services/cities/cities.router.js'; // ייבוא ה-router של הערים

const PORT = process.env.PORT || 4000; // יצירת משתנה לפורט
const server = express(); // יצירת שרת Express
